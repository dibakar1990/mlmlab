...
@section('title', 'Approved Payment')
@section('css')
      ...
      <div class="container-fluid">
        <div class="row justify-content-between">
            <div class="d-flex align-items-end px-1">
                ...
                <li class="breadcrumb-item active">All Approved Payment</li>
                </ol>
            </div>
            <div class="col-sm-2">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <h3 class="card-title">Total Approved Payment: {{$totalAmount}}</h3> 
                </a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                          ...
                          <td class="text-center" style="width: 1px">
                              ...
                              <div class="dropdown-menu dropdown-menu-right" style="min-width: 8rem;">
                                  ...
                                  <a class="dropdown-item text-muted" 
                                      href="{{route('user.payment.approved.show',$value->id)}}" 
                                      title="View" >
