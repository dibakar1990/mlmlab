...
@section('title', 'Approved Payment Show')
@section('css')
@endsection
@section('content')
            ...
            <div class="container-fluid">
                <div class="row justify-content-between">
                    <div class="d-flex align-items-end px-1">
                        <h1 class="d-inline-block mr-4"><small class="text-muted">Approved Payment</small></h1>

                        <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('user.dashboard.index') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('user.payment.approved') }}" class="text-muted">Approved Payment</a></li>
                        </ol>
                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="card ">
                                                    <div class="card-header bg-light align-items-center">
                                                        <h3 class="card-title align-items-center mb-0 pt-1"> Approved Payment Details</h3>
                                                    </div>
                                                    <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" value="Approved" class="form-control"
                                                                            readonly>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
