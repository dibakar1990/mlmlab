                ...
                <div class="row ">
                    <div class="col-sm-6 d-flex align-items-center">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)"> Globals Level</a></li>
                        </ol>
                    </div>
                    <div class="col-sm-6 d-flex flex-row-reverse align-items-center">
                        <a type="button" href="{{ route('admin.globals.create') }}" class="btn btn-primary btn-xs">Add New</a>
                    </div>
                </div>
                <!-- row -->
                                            ...
                                            <tbody>
                                                @foreach($items as $key =>$value)
                                                    <tr>
                                                        ...
                                                        <td>{{ $value->globalPlan->plan_name }}</td>
                                                        ...
                                                        <td>
                                                            <div class="dropdown ms-auto text-right" style="cursor: pointer;">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="{{route('admin.globals.edit',['global' => $value->id])}}" title="Edit"><i class="fas fa-pencil-alt" style="color: blue;"></i> Edit</a>
                                                                    <a class="dropdown-item" href="{{route('admin.globals.show',['global' => $value->id])}}" title="View"><i class="fas fa-eye" style="color: blue;"></i> View</a>
                                                                    <a class="dropdown-item" data-bs-target="#statusChange"
                                                                        href="javascript:void(0);" data-bs-toggle="modal" title="Status"
                                                                        onclick="statusChange('{{ route('admin.global.status', $value->id) }}','Status Change')">
                                                                    ...
                                                                    <a class="dropdown-item" data-bs-target="#deleteConfirm" href="javascript:void(0);" 
                                                                        ...
                                                                        onclick="deleteConfirm('{{ route('admin.globals.destroy',['global' => $value->id])}}')"><i class="fa fa-trash" style="color: red;"></i> Delete</a>
