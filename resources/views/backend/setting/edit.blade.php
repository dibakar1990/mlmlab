    ...
    <form class="needs-validation" id="setting" action="{{route('admin.settings.update',['setting' => $setting->id])}}" method="post" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="card-body p-4">
            <div class="row justify-content-center">
                ...
                <div class="col-md-3 col-sm-6 text-center">
                <label class="form-label">Verical Logo</label>
                    @if($setting->file_path_vertical!='')
                    <img src="{{ $setting->file_url_vertical }}" id="logo_img_vertical"
                        class="rounded border img-fluid mb-2" alt="" />
                    @else
                    <img src="{{ url('backend/images/avatar/1.jpg') }}" id="logo_img_vertical"
                        class="rounded border img-fluid mb-2" alt="" />
                    @endif
                        <a class="btn btn-xs btn-rounded btn-outline-primary" role="button" onclick="$('.js-image-upload-vertical').click();" title="Set Avatar">
                            Choose Image
                        </a>
                    <input type="file" name="file" class="js-image-upload-vertical form-control d-none"
                        accept='.jpg, .jpeg, .png'
                        onchange="document.getElementById('logo_img_vertical').src = window.URL.createObjectURL(this.files[0]);" />
            ...
            <div class="row mt-4">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input id="bonus" type="text" name="bonus" value="{{ $setting->direct_bonus }}"
