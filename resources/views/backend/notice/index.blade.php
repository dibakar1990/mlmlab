...
@section('content')
            ...
            <div class="container-fluid">
                ...
                <div class="row ">
                    ...
                    <div class="col-sm-6 d-flex flex-row-reverse align-items-center">
                        <a type="button" href="{{ route('admin.notices.create') }}" class="btn btn-primary btn-xs">Add New</a>
                    </div>
                </div>
                <!-- row -->
                                                        ...
                                                        <td>
                                                            @if($value->default_status == 1)
                                                                <a class="dropdown-item" data-bs-target="#statusChange"
                                                                    ...
                                                                    onclick="statusChange('{{ route('admin.notice.default.status', $value->id) }}')">
                                                                    <span class="badge light badge-success">Active</span>
                                                                </a>
                                                        ...
                                                        <td>
                                                            <div class="dropdown ms-auto text-right" style="cursor: pointer;">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="{{route('admin.notices.edit',['notice' => $value->id])}}" title="Edit"><i class="fas fa-pencil-alt" style="color: blue;"></i> Edit</a>
                                                                    <a class="dropdown-item" data-bs-target="#deleteConfirm" href="javascript:void(0);" 
                                                                        data-bs-toggle="modal" title="Delete" 
                                                                        onclick="deleteConfirm('{{ route('admin.notices.destroy',['notice' => $value->id])}}')"><i class="fa fa-trash" style="color: red;"></i> Delete</a>
                                                                    
                                                                    <a class="dropdown-item" data-bs-target="#statusChange"
                                                                        href="javascript:void(0);" data-bs-toggle="modal" title="Status"
                                                                        onclick="statusChange('{{ route('admin.notice.status', $value->id) }}','Status Change')">
                                                                        <i class="fas fa-toggle-on pr-1" style="color: green;"></i> Status
                                                                    </a>
                                                                    <a class="dropdown-item" data-bs-target="#statusChange"
                                                                        href="javascript:void(0);" data-bs-toggle="modal" title="Default Status" 
                                                                        onclick="statusChange('{{ route('admin.notice.default.status', $value->id) }}','Default Status Change')">
                                                                        <i class="fas fa-toggle-on pr-1" style="color: #3A82EF;"></i> Default Status
                                                                    </a>
    ...
    <input type="hidden" class="actionUrl" value="{{route('admin.notice.active.action')}}">
@endsection
@section('scripts')
    @parent
