                ...
                <div class="row ">
                    <div class="col-sm-6 d-flex align-items-center">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Canceled Payment</a></li>
                        </ol>
                    </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="dropdown ms-auto text-right" style="cursor: pointer;">
                                                                ...
                                                                <a class="dropdown-item" href="{{route('admin.payment.canceled.show',$value->id)}}" title="View"><i class="fas fa-eye" style="color: blue;"></i> View</a>
