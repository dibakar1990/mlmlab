...
@section('content')
            ...
            <div class="container-fluid">
                ...
                <div class="row ">
                    ...
                    <div class="col-sm-6 d-flex flex-row-reverse align-items-center">
                        <a type="button" href="{{ route('admin.bonus.create') }}" class="btn btn-primary btn-xs">Add New</a>
                    </div>
                </div>
                <!-- row -->
                                                        ...
                                                        <td>
                                                            <div class="dropdown ms-auto text-right" style="cursor: pointer;">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="{{route('admin.bonus.edit',['bonu' => $value->id])}}" title="Edit"><i class="fas fa-pencil-alt" style="color: blue;"></i> Edit</a>
                                                                    <a class="dropdown-item" data-bs-target="#deleteConfirm" href="javascript:void(0);" 
                                                                        data-bs-toggle="modal" title="Delete" 
                                                                        onclick="deleteConfirm('{{ route('admin.bonus.destroy',['bonu' => $value->id])}}')"><i class="fa fa-trash" style="color: red;"></i> Delete</a>
                                                                    
                                                                    <a class="dropdown-item" data-bs-target="#statusChange"
                                                                        href="javascript:void(0);" data-bs-toggle="modal" title="Status"
                                                                        onclick="statusChange('{{ route('admin.bonus.status', $value->id) }}','Status Change')">
    ...
    <input type="hidden" class="actionUrl" value="{{route('admin.bonus.active.action')}}">
@endsection
@section('scripts')
    @parent
