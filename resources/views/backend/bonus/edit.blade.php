...
@section('content')
    ...
    <div class="col-sm-6 d-flex align-items-center">
        <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item active"><a href="{{route('admin.bonus.edit',['bonu' => $data->id])}}">Bonus</a></li>
...
<div class="card mt-4">
    <form class="needs-validation" id="bonus" action="{{route('admin.bonus.update',['bonu' => $data->id])}}" method="post" enctype="multipart/form-data" autocomplete="off">
        @csrf
        @method('PUT')
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select name="level_id" id="level_id" class="js-example-theme-single form-control wide mb-3 @error('level_id') is-invalid @enderror">
                            ...
                            <option value="{{$level->id}}" @if($level->id == $data->level_id){{'selected'}}@endif>{{$level->name}}</option>
                            @endforeach
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select name="plan_id" id="plan_id" class="js-example-theme-single form-control wide mb-3 @error('plan_id') is-invalid @enderror">
                            ...
                            <option value="{{$plan->id}}" @if($plan->id == $data->global_plan_id){{'selected'}}@endif>{{$level->name}}</option>
                            @endforeach
